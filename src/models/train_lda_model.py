...
def main():
	...
	f_input_features = open(BASE_WORKDIR + "data/processed/20newsgroups-bag-of-words.pkl","rb")
	f_input_vocab = open(BASE_WORKDIR + "data/processed/20newsgroups-vocabulary.pkl", 'rb')
	...
	# n_topics_range = xrange(100,5)
	# n_topics_range = [5,20,50,100]
	n_topics_range = [20]
	...
	for n_topics in n_topics_range:
		...
		# n_iterations = N_BASE_ITERATIONS
		...
		plot_filename = BASE_WORKDIR + "reports/figures/" + str(n_topics) + '_topics_lda_loglikelihoods.png'
